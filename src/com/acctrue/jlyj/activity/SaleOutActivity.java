...
public class SaleOutActivity extends UsbprinterActivity implements OnFocusChangeListener {
...
//		}
		if (requestCode==30&&resultCode==30) {
			...
			Stores stores=new Stores(purchaseInDocumentNum, "SaleOut", commonService.cropCode, commonService.lastPhoto, slist,bundle.getBoolean("isYB"));
