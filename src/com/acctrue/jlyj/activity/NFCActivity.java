...
public class NFCActivity extends Activity {
	...
	protected void onResume() {
		// TODO Auto-generated method stub
		super.onResume();	
		nfcAdapter.enableForegroundDispatch(this, pendingIntent, ia, techListsArray); 
	}
	...
	public void checkTheCardNo(String CardNo) {
		...
		HttpGet request = new HttpGet(commonService.serverUrl+"/Portal/ScanServices/CodeService.svc/GetUser/"
				+ CardNo);
		...
		try {
			...
			if (connectStatus == HttpStatus.SC_OK) {
				...
				userInfo.Belong = commonService.serverUrl.equals("http://211.137.215.54:8080/tts")?"移动通信":"吉视传媒";
//				userInfo.Belong = commonService.serverUrl.equals("http://192.168.40.90:9090/TTS")?"移动通信":"吉视传媒";
//				userInfo.Belong = commonService.serverUrl.equals("http://test.51lixin.com/jlyj")?"移动通信":"吉视传媒";
				...
				if (object.getInt("CorpType") == 2) {
					...
					if (object.getString("CorpRankText").equals("药店移动")||object.getString("CorpRankText").equals("药店吉视传媒")) {
						userInfo.CropType = 2;
...
//		goIntoOterMenuActiviy(userInfo);
		return;
	}
...
//		 commonService.serverUrl=settings.getString("severUrl", "");
	...
	public void CellUpdate(final UpdateResult result, final NFCActivity _nfcActivity) {
		// TODO Auto-generated method stub
		...
		alert.setPositiveButton("确定", new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface dialog, int which) {
				// TODO 更新软件版本
				downProgress = new ProgressDialog(
						NFCActivity.this);
	...
	private void downLoadApp(String url) throws Exception
	{
		...
		savePath += "/"
				+ getResources().getString(com.acctrue.jlyj.R.string.app_name) + ".apk";
	...
	public void haveSelectTheServer(SelectServerResult result) {
		...
		if (result.isSelected) {
	       ...
	       //将初始化的值赋给service
			...
			Toast.makeText(this, "当前网络供应商为"+result.belongTo, Toast.LENGTH_SHORT).show();
